    ...
    */
    ...
    func path(in rect: CGRect) -> Path {
        ...
        result.addCurve(to: CGPoint(x: handleTipX, y: handleCenterY),
                        control1: CGPoint(x: inset, y: handleBottomY - handleControlPointOffsetBase),
        ...
        result.addCurve(to: CGPoint(x: inset, y: handleTopY),
                        ...
                        control2: CGPoint(x: inset, y: handleTopY + handleControlPointOffsetBase))
